...
This is called the chain rule. We won't prove it here, but the proof is in any standard calculus textbook if you want to see how it works.
...
\begin{exercise}
\label{exercise:6-4}
Let $f(x)=\frac{1}{\sqrt[3]{x^{2}+3 x}}$. Now try this one: find $f^{\prime}(x)$.
